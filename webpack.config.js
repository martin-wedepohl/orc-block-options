...
const outputPath = '../../wp-content/plugins/orc-options/dist/';
...
const entryPoints = {
	...
	'orc.alumnimeeting-admin.min': jsPath + '/orc.alumnimeeting-admin.js',
	'orc.staff-admin.min': jsPath + '/orc.staff-admin.js',
	'orc.testimonial-admin.min': jsPath + '/orc.testimonial-admin.js',
	'orc.mediacoverage-admin.min': jsPath + '/orc.mediacoverage-admin.js',
	'orc.tour-admin.min': jsPath + '/orc.tour-admin.js',
	'orc.value-admin.min': jsPath + '/orc.value-admin.js',
